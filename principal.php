...
<html lang="en">
  <head>
    ...
    <body>
   <nav class="navbar navbar-expand-sm fixed-top navbar-ligth bg-ligth" aria-label="Third navbar example">
    <div class="container-fluid">
    <img src="images/logo.svg" alt="" width="30" height="24" class="d-inline-block align-text-top">
      <a class="navbar-brand" href="#">3valtech</a>
